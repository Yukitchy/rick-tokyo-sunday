...
COURSES = [
 ...
 dict(id='B', chips=['Indoors, any weather','Ink painting at its source','Warm-up for the sumo in Osaka'], name='Hokusai and the sumo town', tag='Ink, wrestlers, a quiet garden',
  why='Ink painting is on your list, and the man who took it furthest lived and died in this one neighbourhood. Ryogoku is also the sumo district, which makes it a useful warm-up for Osaka on the 28th.',
  steps=[('10:00','Leave the hotel','About 25 minutes by train. A late start after the baseball.'),
         ('10:30','Sumida Hokusai Museum','Hokusai was born here and moved house ninety-three times without leaving the area. The Great Wave, the thirty-six views of Fuji, and the sketchbooks where you can see the brush thinking. Benches in every room.'),
         ('12:15','Chanko lunch','The stew sumo wrestlers eat to build weight, served in the streets where they train.'),
         ('13:30','Ryogoku Kokugikan and the sumo streets','The national sumo arena, the handprints of past champions, and the stable district around it. Wrestlers in yukata on bicycles are a normal sight here.'),
         ('14:30','Kyu-Yasuda Garden','Free, small, and almost empty. A pond garden built to rise and fall with the tide, five minutes from the arena.'),
         ('15:30','Back at the hotel','About 25 minutes by train, in time to pack for Hakone.')],
  stops=['The Blossom Hibiya Tokyo','Sumida Hokusai Museum','Ryogoku Kokugikan','Kyu-Yasuda Garden','The Blossom Hibiya Tokyo'],
  moves='Hotel &rarr; Ryogoku about 25 min by train. Museum &rarr; lunch 8 min on foot. Lunch &rarr; arena 5 min. Arena &rarr; garden 5 min. Ryogoku &rarr; hotel about 25 min.',
  ...
  good='Everything indoors if it rains. Sitting down most of the day. The best possible preparation for the sumo on Sept 28.',
  mind='The Edo-Tokyo Museum next door is closed for renovation, so the Hokusai museum carries the day. It closes on Mondays, which is why this only works on the 20th.',
  links=[('Sumida Hokusai Museum (official)','https://hokusai-museum.jp/?lang=en'),('Ryogoku Kokugikan','https://www.sumo.or.jp/EnKokugikan/'),('Kyu-Yasuda Garden','https://visit-sumida.jp/en/spot/kyu-yasuda-garden/')]),
